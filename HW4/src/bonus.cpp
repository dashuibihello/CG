...
int main()
{
	...
	float vertices[] = {
		...
		//坐标			  //颜色
		0.8f, 5.8f, 0.8f, 1.0f, 0.0f, 0.0f,
		0.8f, 4.2f, 0.8f, 0.0f, 1.0f, 0.0f,
		-0.8f, 5.8f, 0.8f, 0.0f, 0.0f, 1.0f,
		-0.8f, 4.2f, 0.8f, 1.0f, 1.0f, 1.0f,
		0.8f, 5.8f, -0.8f, 1.0f, 1.0f, 1.0f,
		0.8f, 4.2f, -0.8f, 0.0f, 0.0f, 1.0f,
		-0.8f, 5.8f, -0.8f, 0.0f, 1.0f, 0.0f,
		-0.8f, 4.2f, -0.8f, 1.0f, 0.0f, 0.0f,
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glBindVertexArray(VAO);
		glDrawElements(GL_TRIANGLES, 36, GL_UNSIGNED_INT, (void*)(sizeof(float) * 36));
