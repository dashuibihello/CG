...
int main()
{
	...
	//选择光照模式
	//Shader shaderProgram = Shader("1_gouraudVertex.vs", "1_gouraudFragment.fs");
	Shader shaderProgram = Shader("1_phongVertex.vs", "1_phongFragment.fs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		shaderProgram.use();
		shaderProgram.setVec3("objectColor", 0.3f, 0.4f, 0.9f);
		shaderProgram.setVec3("lightColor", 0.7f, 0.0f, 1.0f);
